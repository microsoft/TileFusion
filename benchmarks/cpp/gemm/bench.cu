...
void run_test(std::ofstream& fout) {
  ...
  if (smem_size > kMaxSmemPerBlock) {
    ...
    cudaFuncSetAttribute(
        cutlass_gemm, cudaFuncAttributeMaxDynamicSharedMemorySize, smem_size);
  }
...
//// =============== check correctness =============== ////
  ...
  bool passed1 =
      check_results(thrust::raw_pointer_cast(h_c2.data()), /*tilefusion */
                    thrust::raw_pointer_cast(h_c.data()), /*cutlass */ kM * kN);

  bool passed2 =
      check_results(thrust::raw_pointer_cast(h_c3.data()), /*cublas */
                    thrust::raw_pointer_cast(h_c.data()), /*cutlass */ kM * kN);
